...
sim_Ti = function(n=500, alpha1, alpha2, delta=c(1,1), gamma=c(1,1)){
	library(mvtnorm)
	# random effects
...
###############################################################
sim_longitudinal_data = function(survival_data=surdata, n=500, time=c(0, 0.25, 0.5, 0.75, 1, 3), tau, sigma=1, beta=c(1,1), delta=c(1,1)){
