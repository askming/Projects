...
socketHosts_name <- rep(nodes_name,times=36)
...
t1 = Sys.time()
sim_data_tau50_100_qt25fit_thetahat <- foreach(i=1:100,.packages=c("rjags","R2jags","foreach"),.verbose=T )%dopar%{
    set.seed(123)
...
save(sim_data_tau50_100_qt25fit_thetahat,file="sim_data_tau50_100_qt25fit_thetahat.Rdata")
...
setwd("/work/02784/myang3/QRJM_sim2/results/20150721/thetahat")
load(dir()[3])
post_par = lapply(sim_data_tau50_100_qt25fit_thetahat, as.data.frame)
...
### 1-50 part
t1 = Sys.time()
RE_all100qt50_qt25fit_1_50 = vector(length = 50, mode='list')
for (i in 1:50){
    RE_all100qt50_qt25fit_1_50[[i]] = QRJM_pred_re(curt_data[i], post_par[i], tau=0.25)
}
Sys.time()-t1
setwd("/work/02784/myang3/QRJM_sim2/results/20150721/pred_re")
save(RE_all100qt50_qt25fit_1_50, file="RE_all100qt50_qt25fit_1_50.Rdata")


### ------------------------ ###
### 51-100 part
RE_all100qt50_qt25fit_51_100 = vector(length = 50, mode='list')
for (i in 51:100){
    RE_all100qt50_qt25fit_51_100[[i-50]] = QRJM_pred_re(curt_data[i], post_par[i], tau=0.25)
}
Sys.time()-t1
setwd("/work/02784/myang3/QRJM_sim2/results/20150721/pred_re")
save(RE_all100qt50_qt25fit_51_100, file="RE_all100qt50_qt25fit_51_100.Rdata")
...
RE_all100qt50_qt25fit = vector(length=100, mode='list')
for (i in 1:50) RE_all100qt50_qt25fit[[i]] = RE_all100qt50_qt25fit_1_50[[i]]
for (i in 51:100) RE_all100qt50_qt25fit[[i]] = RE_all100qt50_qt25fit_1_50[[i-50]]
setwd('/work/02784/myang3/QRJM_sim2/results/20150721/pred_re')
save(RE_all100qt50_qt25fit, file="RE_all100qt50_qt25fit.Rdata")


pre_surv_QRJM_025_025 = pred_surv_QRJM(data=curt_data, par=post_par, pred_re=RE_all100qt50_qt25fit, t=0.25, dt=0.25, gold_std=gold_std_res)
pre_surv_QRJM_025_1 = pred_surv_QRJM(data=curt_data, par=post_par, pred_re=RE_all100qt50_qt25fit, t=0.25, dt=1, gold_std=gold_std_res_025_1)
pre_surv_QRJM_025_2 = pred_surv_QRJM(data=curt_data, par=post_par, pred_re=RE_all100qt50_qt25fit, t=0.25, dt=2, gold_std=gold_std_res_025_2)

QRJM_pred_qt50data_qt25fit = list(pre_surv_QRJM_025_025, pre_surv_QRJM_025_1, pre_surv_QRJM_025_2)
setwd("/work/02784/myang3/QRJM_sim2/results/20150721/pred_re")
save(QRJM_pred_qt50data_qt25fit, file='QRJM_pred_qt50data_qt25fit.Rdata')
