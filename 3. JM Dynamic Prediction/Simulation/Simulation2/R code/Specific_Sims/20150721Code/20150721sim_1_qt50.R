...
t1 = Sys.time()
sim_data_tau25_100_medianfit_thetahat_fewpost <- foreach(i=1:100,.packages=c("rjags","R2jags","foreach"),.verbose=T )%dopar%{
    set.seed(123)
...
save(sim_data_tau25_100_medianfit_thetahat_fewpost,file="sim_data_tau25_100_medianfit_thetahat_fewpost.Rdata")
...
setwd("/work/02784/myang3/QRJM_sim2/results/20150721/thetahat")
load(dir()[3])
post_par = lapply(sim_data_tau25_100_medianfit_thetahat, as.data.frame)
### randomly choose 1k posterior samples out of 3k
# sample1k = sample(seq(1:3e3), 1e3, replace=FALSE)
# dput(sample1k, 'sample1k_qt50.txt')
sample1k = dget('sample1k_qt50.txt')
...
### 1-30 part
t1 = Sys.time()
RE_all100qt25_medianfit_1_30 = vector(length = 30, mode='list')
for (i in 1:30){
    RE_all100qt25_medianfit_1_30[[i]] = QRJM_pred_re(curt_data[i], post_par[i], tau=0.50)
}
Sys.time()-t1
setwd("/work/02784/myang3/QRJM_sim2/results/20150721/pred_re")
save(RE_all100qt25_medianfit_1_30, file="RE_all100qt25_medianfit_1_30.Rdata")


### ------------------------ ###
### 31-65 part
RE_all100qt25_medianfit_31_65 = vector(length = 35, mode='list')
for (i in 31:65){
    RE_all100qt25_medianfit_31_65[[i-30]] = QRJM_pred_re(curt_data[i], post_par[i], tau=0.50)
}
Sys.time()-t1
setwd("/work/02784/myang3/QRJM_sim2/results/20150721/pred_re")
save(RE_all100qt25_medianfit_31_65, file="RE_all100qt25_medianfit_31_65.Rdata")


### ------------------------ ###
### 66-100 part
RE_all100qt25_medianfit_66_100 = vector(length = 35, mode='list')
for (i in 66:100){
    RE_all100qt25_medianfit_66_100[[i-65]] = QRJM_pred_re(curt_data[i], post_par[i], tau=0.50)
}
Sys.time()-t1
setwd("/work/02784/myang3/QRJM_sim2/results/20150721/pred_re")
save(RE_all100qt25_medianfit_66_100, file="RE_all100qt25_medianfit_66_100.Rdata")
...
pre_surv_QRJM_025_025 = pred_surv_QRJM(data=curt_data, par=post_par, pred_re=RE_all100qt25_medianfit, t=0.25, dt=0.25, gold_std=gold_std_res)
pre_surv_QRJM_025_1 = pred_surv_QRJM(data=curt_data, par=post_par, pred_re=RE_all100qt25_medianfit, t=0.25, dt=1, gold_std=gold_std_res_025_1)
pre_surv_QRJM_025_2 = pred_surv_QRJM(data=curt_data, par=post_par, pred_re=RE_all100qt25_medianfit, t=0.25, dt=2, gold_std=gold_std_res_025_2)
